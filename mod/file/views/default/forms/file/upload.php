...
<div>
	<label><?php echo elgg_echo('Genre'); ?></label>
	<?php echo elgg_view('input/tags', array('name' => 'tags', 'value' => $tags)); ?>
</div>

<div>
	<label><?php echo elgg_echo('Writer'); ?></label>
	<?php echo elgg_view('input/tags', array('name' => 'pisac', 'value' => $pisac)); ?>
</div>
<?php
